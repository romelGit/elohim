<template>
    <div
        class="card rounded-md bg-white dark:bg-slate-800 lg:h-full border border-gray-5002 dark:border-slate-700"
        v-if="!overlay"
    >
     ...
     `"
            >
                <div
                    :class="`${
                        addButton ? 'flex flex-row justify-between w-full ' : ''
                    }`"
                >
                    <div class="flex-1">
                        <div
